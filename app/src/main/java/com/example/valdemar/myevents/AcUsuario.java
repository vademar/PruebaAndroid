...
public class AcUsuario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ACCIONES DEL BOTONCITO DE ABAJO
    ...
    //EL MENU EN EL LADO SUPERIOR DERECHA LOS 3 PUNTITOS//
    /*
    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        // Inflate the menu; this adds items to the action bar if it is present.
        getMenuInflater().inflate(R.menu.menu_ac_usuario, menu);
        return true;
    }


    //LO QUE SE DESPLEGA CON LOS 3 PUNTITOS
    @Override
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_ac_usuario, container, false);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            //aqui navegamos pro las pantallas//
            switch (position){
                case 0:
                    UsQR user=new UsQR();
                    return user;
